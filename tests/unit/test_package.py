...
def test_localized_readmes_match_canonical_scope() -> None:
    ...
    shared_commands = [
        ...
        "ragscanner uninstall --yes",
        "ragscanner scan PATH",
        "ragscanner analyze-report REPORT_FILE",
        "ragscanner jobs enqueue-scan PATH",
        ...
        "ragscanner history show SCAN_ID",
        "ragscanner history compare BASELINE_ID CANDIDATE_ID",
        "ragscanner history delete SCAN_ID",
        "ragscanner report SCAN_RESULT",
        "ragscanner serve",
        "ragscanner security scan PATH",
        "ragscanner quality scan PATH",
        "uv sync --frozen",
        "uv run pytest",
    ]
